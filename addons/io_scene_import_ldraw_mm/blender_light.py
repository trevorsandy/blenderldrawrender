...
def create_light(light, empty=None, collection=None):
    ...
    if light.rotation is not None:
        ...
        light.up_vector[0] = light.up_vector[0] * ImportOptions.import_scale
        light.up_vector[1] = light.up_vector[1] * ImportOptions.import_scale
        light.up_vector[2] = light.up_vector[2] * ImportOptions.import_scale
